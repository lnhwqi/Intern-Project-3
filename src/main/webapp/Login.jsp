    ...
    <body>
        ...
        <form method="post" action="Login">
            <table style="width: 420px">
                <tr> 
                    <th>Username: </th>
                    <td><input type="text" id="username1" name="username1" style="width: 100%" value="<%= username %>" required></td>
                </tr>
                <tr> 
                    <th>Password: </th>
                    <td><input type="text" id="password1" name="password1" style="width: 100%" required></td>
                </tr>
                <%
